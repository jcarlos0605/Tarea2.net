...
using tarea2.Sessions;
using tarea2.Web.Controllers.Results;
using tarea2.Web.Models;
using tarea2.Web.Models.Account;
...
{
    public class AccountController : tarea2ControllerBase
    {
